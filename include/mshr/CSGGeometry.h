...
namespace mshr
{
  ...
  class CSGGeometry : public dolfin::Variable
  {
   ...
   public:
    ...
    enum Type { Box, Sphere, Cylinder, Tetrahedron, Ellipsoid, Surface3D, Circle, Ellipse, Rectangle, Polygon, Union, Intersection, Difference, Translation, Scaling, Rotation, TriPolyhedron };
